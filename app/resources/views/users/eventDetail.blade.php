...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="card">
        <div class="card-body">
          <h1 class="h10 my-10">大会詳細</h1>

          <form method="POST" class="border rounded bg-white form-login" action="{{ route('event.reserve') }}">
            @csrf
            <table class="table">
              <tbody>
                <tr>
            ...
            <input hidden name="id" class="form-control my3" value="{{ $event['id'] }}">
